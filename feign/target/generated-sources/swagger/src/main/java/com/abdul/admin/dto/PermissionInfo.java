...
public class PermissionInfo {
  ...
  public PermissionInfo id(Long id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public PermissionInfo name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, permissionInfo.id) &&
        Objects.equals(this.name, permissionInfo.name);
  }
